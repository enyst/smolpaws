...
license: MIT
metadata:
  tags: verification, control-app, feature-map, testing, harness, evidence
  source: backnotprop/pstack (skills/create-verification-skill), by Lauren Tan (@poteto)
  note: "Path convention adapted from .cursor/skills/ to .agents/skills/ for smolpaws; wording otherwise faithful to upstream."
---
