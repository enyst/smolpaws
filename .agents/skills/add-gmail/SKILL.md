...
> How do you want to use Gmail with SmolPaws?
>
> **Option 1: Tool Mode**
...
>    - If prompted for consent screen, choose "External", fill in app name (e.g., "SmolPaws"), your email, and save
>    - For Application type, select **Desktop app**
>    - Name it anything (e.g., "SmolPaws Gmail")
>    - Click **Create**
...
```bash
sleep 2 && launchctl list | grep smolpaws
```
...
> - Create a Gmail label (e.g., "SmolPaws")
...
Complete all Tool Mode steps above before continuing. Verify Gmail tools work by having the user test `@smolpaws check my recent emails`.
...
```bash
tail -f logs/smolpaws.log | grep -E "(email|Email)"
```
